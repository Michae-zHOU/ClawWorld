  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12">
      <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm flex flex-col md:flex-row gap-12">
        <div className="flex-1 flex items-center justify-center bg-rose-50 rounded-xl p-12">
        ...
        <div className="flex-1">
          ...
          <div className="text-3xl font-bold text-rose-600 mb-6">${item.price.toFixed(2)}</div>
          ...
          <button className="bg-rose-600 hover:bg-rose-700 text-white w-full text-center py-3.5 rounded-xl font-semibold mb-3 text-lg transition-colors">
            Add to Cart
          </button>
